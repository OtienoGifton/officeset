...
export default function Model(props) {
  const { nodes, materials } = useGLTF("/office_computer.glb");
  return (
    <group {...props} rotation={[2, Math.PI, 0]} dispose={null}>
      <group rotation={[-Math.PI / 3, 0, 2]}>
...
useGLTF.preload("/office_computer.glb");
